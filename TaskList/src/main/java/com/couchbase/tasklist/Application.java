...
public class Application extends android.app.Application {
    ...
    private static final String GUEST_DATABASE_NAME = "tasklist";

    //to use CouchabseServer online host
    ...
    //to use CouchbaseServer on localhost
    //REQUIRES CouchbaseServer and CouchbaseGateway installed locally
    //to use when running on device
    //private static final String SYNC_URL_HTTP = "http://127.0.0.1:4984/tasklist/";
    //to use when running on android emulator
    //private static final String SYNC_URL_HTTP = "http://10.0.2.2:4984/tasklist/";
    //to use when running on genymotion
    //REQUIRES genymotinon (http://www.genymotion.com/)
    private static final String SYNC_URL_HTTP = "http://192.168.56.1:4984/tasklist/";
